...
_isr8:
    ...
    push byte 8             ; Note that we don't push a value on the stack in this one!
                            ; it pushes on already! use this type of stub for exceptions
...
;This is our common ISR stub. It save the processor state, sets
...
isr_common_stub:
    ...
    pop ds
    popa
    add esp, 8      ; Cleans up the pushed error code and pusdhed ISR number
...
_irq0:
    cli
    push byte 0         ; Note that these don't push an error on the stack
